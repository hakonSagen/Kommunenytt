...
def build_prompt(protocol: ParsedProtocol, case: ParsedCase) -> str:
    ...
    return (
        ...
        "- Brødteksten skal dekke dette i en naturlig rekkefølge: hva saken gjelder, hva som ble vedtatt, forslag fra politikere som ble nedstemt, avstemning, detaljer/tall/tiltak og veien videre.\n"
        ...
        "- Skriv klart hva saken gjelder, og hvem saken påvirker, når dette fremgår av dokumentene.\n"
        ...
        "- Ta med politiske forslag som ble nedstemt når de står i protokollen. Skriv hvem som fremmet forslaget, hva forslaget gikk ut på og hvordan avstemningen endte.\n"
        "- Avstemning skal få ekstra oppmerksomhet når flere forslag settes opp mot hverandre.\n"
        "- Opplys alltid dersom politikere fra samme parti stemte ulikt, og skriv hvem som stemte hva, når dette fremgår av dokumentene.\n"
        "- Opplys alltid dersom ordfører og varaordfører ikke stemte det samme, når dette fremgår av dokumentene.\n"
        "- Opplys alltid dersom ordføreren stemte på et forslag som ikke fikk flertall, når dette fremgår av dokumentene.\n"
        "- Forklar økonomi, beløp, tiltak, eiendommer, steder, datoer, frister og rammer når dette finnes i kilden. Detaljer om hva som skal gjøres og gjennomføres skal få god plass.\n"
        ...
        "- Avslutt med veien videre når dokumentene opplyser hva som skal skje videre i saken.\n"
        "- Dersom det ikke står noe i møteinnkallingen eller protokollen om gjennomføring, kostnader, tidspunkt, frister, tidsplan for gjennomføring eller andre viktige nøkkelopplysninger, skriv tydelig i saken at dokumentene ikke opplyser dette.\n"
...
def extract_supporting_fact_lines(section: str | None, limit: int = 12) -> list[str]:
    ...
    keyword_pattern = re.compile(
        ...
        r"avstemning|stemte|stemmer|forslag|flertall|mindretall|parti|"
        r"ordfører|varaordfører|nedstemt|falt|vedtatt|"
